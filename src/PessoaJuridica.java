public class PessoaJuridica extends Cliente{
    ...
    public String toString(){
        String product = "Nome " + this.getNome() + " CNPJ: " + this.cnpj + "\nEndereço " + this.getEndereco() + "\nQtd Funcionários: " + this.numFuncionarios + " Setor: " + this.setor + " Data de Cadastro: " + this.getData();
        return product;
    }
    ...
    public boolean equals(Object obj){
        if ((obj == null) || ! this.getClass().equals(obj.getClass())){
            ...
            PessoaJuridica teste = (PessoaJuridica) obj;
            return (teste.getCNPJ().equals(this.cnpj));
        }
    }
}
